...
import AdhocColumnEditPopover from './AdhocColumnEditPopover';
...
//it's copy of AdhocFilterOption,so most of code is same and may be unwanted
export default class AdhocColumnOption extends React.PureComponent {
  constructor(props) {
    super(props);
...
AdhocColumnOption.propTypes = propTypes;
