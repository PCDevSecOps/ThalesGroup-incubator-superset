const DEF_INVALID_CREDENTIALS_ERROR_MESSAGE = "Invalid credentials, please enter correct username and password.";
const DEF_AUTHORIZATION_FAILED_ERROR_MESSAGE = "Access denied, please contact administrator.";
