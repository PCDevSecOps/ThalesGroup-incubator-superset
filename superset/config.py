...
# SQLALCHEMY_DATABASE_URI = 'mysql://mysqluser:mysqluserpassword@localhost/superset'
# SQLALCHEMY_DATABASE_URI = 'postgresql://postgresuser:pguserpassword@localhost/superset'
